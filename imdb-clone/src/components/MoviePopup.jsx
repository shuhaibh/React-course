...
function MoviePopup({ movie, onClose }) {
  ...
  const language =
    languageMap[original_language] || original_language?.toUpperCase() || "N/A";
  const genres =
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
      ...
      <div className="bg-black text-white rounded-xl overflow-hidden w-[90%] max-w-[800px] flex flex-col md:flex-row relative shadow-2xl">
        {/* Left: Poster */}
